namespace Scintilla.Lexers
{
    ...
    public enum Html
    {
        ...
        SgmlEntity = 28,
        SgmlComment = 29,
        SgmlSgml1stParameterComment = 30,
        SgmlBlockDefault = 31,
        JavaScriptStart = 40,
        ...
        JavaScriptDoubleString = 48,
        JavaScriptSingleString = 49,
        JavaScriptSymbols = 50,
        JavaScriptStringEol = 51,
        JavaScriptRegex = 52,
        ...
        AspJavaScriptDoubleString = 63,
        AspJavaScriptSingleString = 64,
        AspJavaScriptSymbols = 65,
        AspJavaScriptStringEol = 66,
        AspJavaScriptRegex = 67,
        VBScriptStart = 70,
        VBScriptDefault = 71,
        VBScriptCommentLine = 72,
        VBScriptNumber = 73,
        VBScriptWord = 74,
        VBScriptString = 75,
        VBScriptIdentifier = 76,
        VBScriptStringEol = 77,
        AspVBScriptStart = 80,
        AspVBScriptDefault = 81,
        AspVBScriptCommentLine = 82,
        AspVBScriptNumber = 83,
        AspVBScriptWord = 84,
        AspVBScriptString = 85,
        AspVBScriptIdentifier = 86,
        AspVBScriptStringEol = 87,
        PythonStart = 90,
        PythonDefault = 91,
        PythonCommentLine = 92,
        PythonNumber = 93,
        PythonString = 94,
        PythonCharacter = 95,
        PythonWord = 96,
        PythonTriple = 97,
        PythonTripleDouble = 98,
        PythonClassName = 99,
        PythonDefName = 100,
        PythonOperator = 101,
        ...
        AspPythonCommentLine = 107,
        AspPythonNumber = 108,
        AspPythonString = 109,
        AspPythonCharacter = 110,
        AspPythonWord = 111,
        AspPythonTriple = 112,
        AspPythonTripleDouble = 113,
        AspPythonClassName = 114,
        AspPythonDefName = 115,
