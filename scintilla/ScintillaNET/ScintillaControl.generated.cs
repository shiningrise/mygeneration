namespace Scintilla
{
    ...
    public partial class ScintillaControl
    {
        ...
        /// <include file='..\Help\GeneratedInclude.xml' path='root/Properties/Property[@name="HotspotActiveFore"]/*' />
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual int HotspotActiveFore
        {
            get
            {
                return this.SendMessageDirect(2494);
            }
            set
            {
                this.SendMessageDirect(2410, value);
            }
        }
        /// <include file='..\Help\GeneratedInclude.xml' path='root/Properties/Property[@name="HotspotActiveBack"]/*' />
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual int HotspotActiveBack
        {
            get
            {
                return this.SendMessageDirect(2495);
            }
            set
            {
                this.SendMessageDirect(2411, value);
            }
        }
        /// <include file='..\Help\GeneratedInclude.xml' path='root/Properties/Property[@name="IsHotspotActiveUnderline"]/*' />
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual bool IsHotspotActiveUnderline
        {
            get
            {
                return (this.SendMessageDirect(2496) != 0);
            }
            set
            {
                this.SendMessageDirect(2412, value);
            }
        }
        /// <include file='..\Help\GeneratedInclude.xml' path='root/Properties/Property[@name="IsHotspotSingleLine"]/*' />
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual bool IsHotspotSingleLine
        {
            get
            {
                return (this.SendMessageDirect(2497) != 0);
            }
            set
            {
                this.SendMessageDirect(2421, value);
            }
        }
        ...
        /// <include file='..\Help\GeneratedInclude.xml' path='root/Methods/Method[@name="StyleGetFont"]/*' />
        public virtual string StyleGetFont(int style)
        {
            string result;
            this.SendMessageDirect(2486, style, out result);
            return result;
        }
        ...
        // NOTE: originally a property:StyleGetFore
        /// <include file='..\Help\GeneratedInclude.xml' path='root/Methods/Method[@name="StyleGetFore"]/*' />
        public virtual int StyleGetFore(int style)
        {
            return this.SendMessageDirect(2481, style);
        }
        // NOTE: originally a property:StyleGetBack
        /// <include file='..\Help\GeneratedInclude.xml' path='root/Methods/Method[@name="StyleGetBack"]/*' />
        public virtual int StyleGetBack(int style)
        {
            return this.SendMessageDirect(2482, style);
        }
        // NOTE: originally a property:StyleGetBold
        /// <include file='..\Help\GeneratedInclude.xml' path='root/Methods/Method[@name="StyleGetBold"]/*' />
        public virtual bool StyleGetBold(int style)
        {
            return (this.SendMessageDirect(2483, style) != 0);
        }
        // NOTE: originally a property:StyleGetItalic
        /// <include file='..\Help\GeneratedInclude.xml' path='root/Methods/Method[@name="StyleGetItalic"]/*' />
        public virtual bool StyleGetItalic(int style)
        {
            return (this.SendMessageDirect(2484, style) != 0);
        }
        // NOTE: originally a property:StyleGetSize
        /// <include file='..\Help\GeneratedInclude.xml' path='root/Methods/Method[@name="StyleGetSize"]/*' />
        public virtual int StyleGetSize(int style)
        {
            return this.SendMessageDirect(2485, style);
        }
        // NOTE: originally a property:StyleGetEOLFilled
        /// <include file='..\Help\GeneratedInclude.xml' path='root/Methods/Method[@name="StyleGetEOLFilled"]/*' />
        public virtual bool StyleGetEOLFilled(int style)
        {
            return (this.SendMessageDirect(2487, style) != 0);
        }
        // NOTE: originally a property:StyleGetUnderline
        /// <include file='..\Help\GeneratedInclude.xml' path='root/Methods/Method[@name="StyleGetUnderline"]/*' />
        public virtual bool StyleGetUnderline(int style)
        {
            return (this.SendMessageDirect(2488, style) != 0);
        }
        // NOTE: originally a property:StyleGetCase
        /// <include file='..\Help\GeneratedInclude.xml' path='root/Methods/Method[@name="StyleGetCase"]/*' />
        public virtual int StyleGetCase(int style)
        {
            return this.SendMessageDirect(2489, style);
        }
        // NOTE: originally a property:StyleGetCharacterSet
        /// <include file='..\Help\GeneratedInclude.xml' path='root/Methods/Method[@name="StyleGetCharacterSet"]/*' />
        public virtual int StyleGetCharacterSet(int style)
        {
            return this.SendMessageDirect(2490, style);
        }
        // NOTE: originally a property:StyleGetVisible
        /// <include file='..\Help\GeneratedInclude.xml' path='root/Methods/Method[@name="StyleGetVisible"]/*' />
        public virtual bool StyleGetVisible(int style)
        {
            return (this.SendMessageDirect(2491, style) != 0);
        }
        // NOTE: originally a property:StyleGetChangeable
        /// <include file='..\Help\GeneratedInclude.xml' path='root/Methods/Method[@name="StyleGetChangeable"]/*' />
        public virtual bool StyleGetChangeable(int style)
        {
            return (this.SendMessageDirect(2492, style) != 0);
        }
        // NOTE: originally a property:StyleGetHotSpot
        /// <include file='..\Help\GeneratedInclude.xml' path='root/Methods/Method[@name="StyleGetHotSpot"]/*' />
        public virtual bool StyleGetHotSpot(int style)
        {
            return (this.SendMessageDirect(2493, style) != 0);
        }
