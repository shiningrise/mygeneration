...
#Region "@@IDENTITY Logic"
        ...
        Protected Overrides Sub HookupRowUpdateEvents(ByVal adapter As DbDataAdapter)
            ...
            If Me.GetAutoKeyColumns().Length > 0 Then
                Dim da As VistaDBDataAdapter = CType(adapter, VistaDBDataAdapter)
        ...
        Protected Sub OnRowUpdated(ByVal sender As Object, ByVal e As VistaDBRowUpdatedEventArgs)
            ...
            Try
                If e.Status = UpdateStatus.[Continue] AndAlso e.StatementType = StatementType.Insert Then
                    ...
                    Dim cmd As VistaDBCommand = New VistaDBCommand

                    Dim col As String

                    For Each col In identityCols

                        cmd.CommandText = "SELECT LastIdentity([" + col + "]) FROM [" + Me.QuerySource + "]"
...
#End Region
        ...
        Protected Overrides Function _LoadFromRawSql(ByVal rawSql As String, ByVal ParamArray parameters() As Object) As IDbCommand
            ...
            For Each o In parameters
                ...
                Dim p As VistaDBParameter = New VistaDBParameter(param, o)
