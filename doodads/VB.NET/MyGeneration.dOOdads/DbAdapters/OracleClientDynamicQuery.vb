...
Namespace MyGeneration.dOOdads
	...
	Public Class OracleClientDynamicQuery
		...
		Protected Function GetAggregate(ByVal wItem As AggregateParameter, ByVal withAlias As Boolean) As String
			...
			If wItem.Function = AggregateParameter.Func.StdDev Then
				query += ", 10)"
			End If
		...
		Private Sub AddParameter(ByVal cmd As OracleCommand, ByVal paramName As String, ByVal data As Object)
#If (VS2005) Then
