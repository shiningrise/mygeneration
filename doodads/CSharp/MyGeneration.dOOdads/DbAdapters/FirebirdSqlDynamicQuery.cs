...
{
	/// <summary>
	/// FirebirdSqlDynamicQuery is the Firebird implementation of DynamicQuery
	/// </summary>
	public class FirebirdSqlDynamicQuery : DynamicQuery
	{
		...
		{
			base.AddResultColumn(D(columnName));
		}
		...
		{
			FirebirdSqlEntity entity = this._entity as FirebirdSqlEntity;
			if(entity._dialect == 3)
			{
				text = '"' + text + '"';
			}
