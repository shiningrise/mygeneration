...
#Region "Parameters"
        Protected Class Parameters
            ...
            Public Shared ReadOnly Property EmployeeID() As OleDbParameter
                Get
                    Return New OleDbParameter("@EmployeeID", OleDbType.Numeric, 0)
                End Get
            End Property

            Public Shared ReadOnly Property LastName() As OleDbParameter
                Get
                    Return New OleDbParameter("@LastName", OleDbType.VarWChar, 20)
                End Get
            End Property

            Public Shared ReadOnly Property FirstName() As OleDbParameter
                Get
                    Return New OleDbParameter("@FirstName", OleDbType.VarWChar, 10)
                End Get
            End Property

            Public Shared ReadOnly Property Title() As OleDbParameter
                Get
                    Return New OleDbParameter("@Title", OleDbType.VarWChar, 30)
                End Get
            End Property

            Public Shared ReadOnly Property TitleOfCourtesy() As OleDbParameter
                Get
                    Return New OleDbParameter("@TitleOfCourtesy", OleDbType.VarWChar, 25)
                End Get
            End Property

            Public Shared ReadOnly Property BirthDate() As OleDbParameter
                Get
                    Return New OleDbParameter("@BirthDate", OleDbType.Date, 0)
                End Get
            End Property
            ...
            Public Shared ReadOnly Property Address() As OleDbParameter
                Get
                    Return New OleDbParameter("@Address", OleDbType.VarWChar, 60)
                End Get
            End Property

            Public Shared ReadOnly Property City() As OleDbParameter
                Get
                    Return New OleDbParameter("@City", OleDbType.VarWChar, 15)
                End Get
            End Property

            Public Shared ReadOnly Property Region() As OleDbParameter
                Get
                    Return New OleDbParameter("@Region", OleDbType.VarWChar, 15)
                End Get
            End Property

            Public Shared ReadOnly Property PostalCode() As OleDbParameter
                Get
                    Return New OleDbParameter("@PostalCode", OleDbType.VarWChar, 10)
                End Get
            End Property

            Public Shared ReadOnly Property Country() As OleDbParameter
                Get
                    Return New OleDbParameter("@Country", OleDbType.VarWChar, 15)
                End Get
            End Property

            Public Shared ReadOnly Property HomePhone() As OleDbParameter
                Get
                    Return New OleDbParameter("@HomePhone", OleDbType.VarWChar, 24)
                End Get
            End Property

            Public Shared ReadOnly Property Extension() As OleDbParameter
                Get
                    Return New OleDbParameter("@Extension", OleDbType.VarWChar, 4)
                End Get
            End Property

            Public Shared ReadOnly Property Photo() As OleDbParameter
                Get
                    Return New OleDbParameter("@Photo", OleDbType.LongVarBinary, 0)
                End Get
            End Property

            Public Shared ReadOnly Property Notes() As OleDbParameter
                Get
                    Return New OleDbParameter("@Notes", OleDbType.LongVarWChar, 0)
                End Get
            End Property

            Public Shared ReadOnly Property ReportsTo() As OleDbParameter
                Get
                    Return New OleDbParameter("@ReportsTo", OleDbType.Numeric, 0)
                End Get
            End Property
