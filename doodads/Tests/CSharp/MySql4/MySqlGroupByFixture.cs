...
{
	[TestFixture]
	public class MySqlGroupByFixture
	{
		...
		public void GroupByWithRollup()
		{
			...
			aggTest.Query.CountAll = true;
			aggTest.Query.CountAllAlias = "Count";
			aggTest.Query.AddResultColumn(SQLite.AggregateTest.ColumnNames.IsActive);
			aggTest.Query.AddResultColumn(SQLite.AggregateTest.ColumnNames.DepartmentID);
			aggTest.Query.AddGroupBy(SQLite.AggregateTest.ColumnNames.IsActive);
			aggTest.Query.AddGroupBy(SQLite.AggregateTest.ColumnNames.DepartmentID);
			Assert.IsTrue(aggTest.Query.Load());
