...
{
	[TestFixture]
	public class PostgreSQLAggregateFixture
	{
		PostgreSQL.AggregateTest aggTest = new PostgreSQL.AggregateTest();
		
		[TestFixtureSetUp]
		public void Init()
		{
			aggTest.ConnectionStringConfig = "PostgreSQLConnection";
