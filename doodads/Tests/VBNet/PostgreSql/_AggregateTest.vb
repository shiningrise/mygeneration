...
Namespace MyGeneration.dOOdads.Tests.PostgreSQL
	...
	Public MustInherit Class _AggregateTest
		...
		Public Function LoadAll() As Boolean
			...
			Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "AggregateTest_load_all", parameters)
		...
		Public Overridable Function LoadByPrimaryKey(ByVal ID As Integer) As Boolean
			...
			Return MyBase.LoadFromSql(Me.SchemaStoredProcedure + "AggregateTest_load_by_primarykey", parameters)
...
#Region "Parameters"
		Protected Class Parameters
			...
			Public Shared ReadOnly Property ID() As NpgsqlParameter
				Get
					Return New NpgsqlParameter("ID", NpgsqlTypes.NpgsqlDbType.Integer, 0)
				End Get
			End Property

			Public Shared ReadOnly Property DepartmentID() As NpgsqlParameter
				Get
			...
			Public Shared ReadOnly Property Age() As NpgsqlParameter
				Get
					Return New NpgsqlParameter("Age", NpgsqlTypes.NpgsqlDbType.Integer, 0)
				End Get
			End Property

			Public Shared ReadOnly Property HireDate() As NpgsqlParameter
				Get
					Return New NpgsqlParameter("HireDate", NpgsqlTypes.NpgsqlDbType.Timestamp, 0)
				End Get
			End Property

			Public Shared ReadOnly Property Salary() As NpgsqlParameter
				Get
					Return New NpgsqlParameter("Salary", NpgsqlTypes.NpgsqlDbType.Numeric, 0)
				End Get
			End Property

			Public Shared ReadOnly Property IsActive() As NpgsqlParameter
				Get
...
#End Region
		...
		Protected Overrides Function GetInsertCommand() As IDbCommand
			...
			cmd.CommandText = Me.SchemaStoredProcedure + "AggregateTest_insert"
		...
		Protected Overrides Function GetUpdateCommand() As IDbCommand
			...
			Dim cmd As NpgsqlCommand = New NpgsqlCommand
			cmd.CommandType = CommandType.StoredProcedure
			cmd.CommandText = Me.SchemaStoredProcedure + "AggregateTest_update"
		...
		Protected Overrides Function GetDeleteCommand() As IDbCommand
			...
			Dim cmd As NpgsqlCommand = New NpgsqlCommand
			cmd.CommandType = CommandType.StoredProcedure
			cmd.CommandText = Me.SchemaStoredProcedure + "AggregateTest_delete"
