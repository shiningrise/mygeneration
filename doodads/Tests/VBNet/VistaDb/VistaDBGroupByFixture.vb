...
Namespace MyGeneration.dOOdads.Tests.VistaDB
	...
	<TestFixture()> _
	Public Class VistaDBSQLGroupByFixture
		...
		Public Sub Init()
			...
			aggTest.ConnectionString = Connections.VistaDBConnection
		End Sub
		...
		Public Sub OneGroupBy()
			...
			Assert.AreEqual(3, aggTest.RowCount, aggTest.Query.LastQuery)
		End Sub
		...
		Public Sub TwoGroupBy()
			...
			Assert.IsTrue(aggTest.Query.Load())
			Assert.AreEqual(12, aggTest.RowCount, aggTest.Query.LastQuery)
		End Sub
		...
		<Test()> _
		  Public Sub GroupByWithTop()
			...
			'		aggTest.Query.AddOrderBy(aggTest.Query, WhereParameter.Dir.DESC)
			Assert.IsTrue(aggTest.Query.Load())
			Assert.AreEqual(aggTest.Query.Top, aggTest.RowCount, aggTest.Query.LastQuery)
		End Sub
		...
		<Test()> _
		  Public Sub GroupByWithDistinct()
			...
			'aggTest.Query.AddOrderBy(aggTest.Query, WhereParameter.Dir.DESC)
			Assert.IsTrue(aggTest.Query.Load())
			Assert.AreEqual(5, aggTest.RowCount, aggTest.Query.LastQuery)
		End Sub
