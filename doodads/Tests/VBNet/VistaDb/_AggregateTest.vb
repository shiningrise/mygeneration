...
#Region "Parameters"
		Protected Class Parameters
			...
			Public Shared ReadOnly Property ID() As VistaDBParameter
				Get
					Return New VistaDBParameter("@ID", VistaDBType.Int32, 0)
				End Get
			End Property

			Public Shared ReadOnly Property DepartmentID() As VistaDBParameter
				Get
					Return New VistaDBParameter("@DepartmentID", VistaDBType.Int32, 0)
				End Get
			End Property

			Public Shared ReadOnly Property FirstName() As VistaDBParameter
				Get
					Return New VistaDBParameter("@FirstName", VistaDBType.Varchar, 25)
				End Get
			End Property

			Public Shared ReadOnly Property LastName() As VistaDBParameter
				Get
					Return New VistaDBParameter("@LastName", VistaDBType.Varchar, 15)
				End Get
			End Property

			Public Shared ReadOnly Property Age() As VistaDBParameter
				Get
					Return New VistaDBParameter("@Age", VistaDBType.Int32, 0)
				End Get
			End Property
			...
			Public Shared ReadOnly Property Salary() As VistaDBParameter
				Get
					Return New VistaDBParameter("@Salary", VistaDBType.Currency, 0)
				End Get
			End Property

			Public Shared ReadOnly Property IsActive() As VistaDBParameter
				Get
					Return New VistaDBParameter("@IsActive", VistaDBType.Boolean, 0)
				End Get
			End Property
